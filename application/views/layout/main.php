                            ...
                            <ul class="dropdown-menu dropdown-messages dropdown-menu-right">
                                    ...
                                    <div class="dropdown-messages-box">
                                        <a class="dropdown-item float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle"
                                                src="<?php echo base_url(lib) ?>img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a class="dropdown-item float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle"
                                                src="<?php echo base_url(lib) ?>img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a class="dropdown-item float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle"
                                                src="<?php echo base_url(lib) ?>img/profile.jpg">
                                        </a>
                                        <div class="media-body ">
                        ...
                        <div>
                                ...
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar"
                                            src="<?php echo base_url(lib) ?>img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar"
                                            src="<?php echo base_url(lib) ?>img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar"
                                            src="<?php echo base_url(lib) ?>img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar"
                                            src="<?php echo base_url(lib) ?>img/a8.jpg">
                                    </div>
                                    <div class="media-body">
