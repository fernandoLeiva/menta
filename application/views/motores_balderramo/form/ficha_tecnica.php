<div class="form-group">
    <label class="font-normal control-label">Opciones:</label>
    <table class="table">
        <tbody>
            <tr>
                <td><label class="checkbox-inline i-checks"> <input name="ft[]" type="checkbox" value="option1"> Aspirado </label>
                </td>
                <td><label class="i-checks"> <input name="ft[]" type="checkbox" value="option2"> Inyeccion Mecanica </label></td>
                <td><label class="i-checks"> <input name="ft[]" type="checkbox" value="option3"> Inyeccion Electrica </label></td>
            </tr>
        </tbody>
